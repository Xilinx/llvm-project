...
struct TosaFoldConstantTransposeBase: public OpRewritePattern<TosaOp> {
  TosaFoldConstantTransposeBase(MLIRContext* ctxt) : OpRewritePattern<TosaOp>(ctxt) {}
};

struct TosaFoldConstantTranspose : public TosaFoldConstantTransposeBase<tosa::TransposeOp> {
  using TosaFoldConstantTransposeBase::TosaFoldConstantTransposeBase;
...
struct TosaFoldConstantReciprocal : public TosaFoldConstantTransposeBase<ReciprocalOp> {
  using TosaFoldConstantTransposeBase::TosaFoldConstantTransposeBase;
