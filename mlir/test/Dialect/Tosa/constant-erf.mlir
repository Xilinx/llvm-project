...
func.func @erf_fold() -> tensor<4x6xf32> {
  ...
  // CHECK-SAME{LITERAL}: [[0.196344286, 0.0983697995, 0.597845793, 0.962372899, -0.893818676, 0.999963939],
  // CHECK-SAME{LITERAL}: [-0.231145486, 0.957220971, 0.969331145, -0.0136527214, -0.255664647, -0.941481471],
  // CHECK-SAME{LITERAL}: [-0.0905265808, 0.0857041776, 5.445020e-01, 0.889718651, 0.270594627, 0.674054205],
  // CHECK-SAME{LITERAL}: [0.514238417, -0.64380151, 0.989490389, 0.156615078, 0.971673727, -0.853608847]]
  // CHECK-NOT: tosa.erf
  // CHECK: return [[RES]]
