...
// CHECK-NEXT:          %6 = demo.foo %extracted_slice_2, %extracted_slice_3, %extracted_slice_4 {opName = "gemm"} : tensor<4x32xf64>, tensor<32x8xf64>, tensor<4x8xf64> to tensor<4x8xf64>
